...
class GNY201JOverDay6(WidgetOperation):
    @case_run(False)
    def run(self):
        self.case_module = u"模式定时"  # 用例所属模块
        self.case_title = u'鱼缸模式开启23小时59分钟，关闭23小时59分钟定时是否正确执行'  # 用例名称
        self.zentao_id = 1305  # 禅道ID
    ...
    def case(self):
        ...
        delay_time_1, delay_time_2 = ["delay", "23:59"], ["delay", "23:59"]
