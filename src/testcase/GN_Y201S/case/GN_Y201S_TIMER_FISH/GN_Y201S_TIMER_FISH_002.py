...
class GNY201STimerFish2(WidgetOperation):
    @case_run(False)
    def run(self):
        self.case_module = u"FUT_MTIMER_FISH_鱼缸模式(#59)"  # 用例所属模块
        self.case_title = u'FUT_MTIMER_FISH_鱼缸模式开启1小时，关闭1小时功能是否正常'  # 用例名称
        self.zentao_id = "441"  # 禅道ID
    ...
    def case(self):
        ...
        time_1, time_2 = ["delay", "01:00"], ["delay", "01:00"]
