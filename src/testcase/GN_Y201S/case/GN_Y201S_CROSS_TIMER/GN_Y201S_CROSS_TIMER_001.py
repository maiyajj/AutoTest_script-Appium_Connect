...
class GNY201SCrossTimer1(WidgetOperation):
    @case_run(False)
    def run(self):
    ...
    def case(self):
        ...
        time_5 = ["delay", "00:10"]
        start_time_5, set_time_5 = self.create_delay_timer(now, time_5, "power_on", 150)
        ...
        time_1 = 5
        start_time_1, set_time_1, cycle1 = self.create_normal_timer(now, time_1, "power_on", u"永不", delay_s=240)

        time_2 = 10
        start_time_2, set_time_2, cycle2 = self.create_normal_timer(now, time_2, "power_on", u"永不", delay_s=240)

        time_3 = 15
        start_time_3, set_time_3, cycle3 = self.create_normal_timer(now, time_3, "power_off", u"永不", delay_s=240)

        time_4 = 20
        start_time_4, set_time_4, cycle4 = self.create_normal_timer(now, time_4, "power_off", u"永不", delay_s=240)
        ...
        time_6, time_7 = ["delay", "00:03"], ["delay", "00:03"]
        tmp = self.create_cycle_timer("cycle_timer_page", now, time_6, time_7, u"4次", 210)
        ...
        time_16 = ["delay", "00:10"]
        start_time_16, set_time_16 = self.create_delay_timer(set_time_5, time_16, "power_off", 150, True)
