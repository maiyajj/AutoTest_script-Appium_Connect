...
class GNY201HNormalTimer6(WidgetOperation):
    @case_run(False)
    def run(self):
        self.case_module = u"普通定时(#246)"  # 用例所属模块
        self.case_title = u'在线状态，1组开与1组关按自定义方式执行的定时执行状态检查'  # 用例名称
        self.zentao_id = "2060"  # 禅道ID
    ...
    def case(self):
        ...
        start_time_1, set_time_1, start_time_2, set_time_2, cycle1, cycle2 = self.create_normal_timer(
            now, time_1, time_2, loop=[u"周一", u"周三", u"周五"])
