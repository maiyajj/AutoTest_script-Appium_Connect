...
class GNF1331Timer14(WidgetOperation):
    @case_run(False)
    def run(self):
        self.case_module = u"定时器(#9)"  # 用例所属模块
        self.case_title = u'在线状态，随机各层设置9组普通定时，周末执行的定时执行状态检查'  # 用例名称
        self.zentao_id = "97"  # 禅道ID
    ...
    def case(self):
        ...
        start_time_4, set_time_4 = self.create_normal_timer("mid_timer_page", now, time_4, "power_on", loop=u"周末")
        start_time_5, set_time_5 = self.create_normal_timer("mid_timer_page", now, time_5, "power_off", loop=u"周末")
        start_time_6, set_time_6 = self.create_normal_timer("mid_timer_page", now, time_6, "power_on", loop=u"周末")
        ...
        start_time_7, set_time_7 = self.create_normal_timer("down_timer_page", now, time_7, "power_on", loop=u"周末")
        start_time_8, set_time_8 = self.create_normal_timer("down_timer_page", now, time_8, "power_off", loop=u"周末")
        start_time_9, set_time_9 = self.create_normal_timer("down_timer_page", now, time_9, "power_on", loop=u"周末")
