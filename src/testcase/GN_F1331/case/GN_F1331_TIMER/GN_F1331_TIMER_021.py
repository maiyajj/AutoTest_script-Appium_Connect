...
class GNF1331Timer21(WidgetOperation):
    @case_run(False)
    def run(self):
        self.case_module = u"定时器(#9)"  # 用例所属模块
        self.case_title = u'在线状态，单层1组开与1组关按自定义执行的普通定时执行状态检查'  # 用例名称
        self.zentao_id = "80"  # 禅道ID
    ...
    def case(self):
        ...
        time_1, time_2 = ["point", "10:00"], ["point", "14:00"]
        ...
        # 定时执行
        launch_normal_once_dict = self.check_launch_normal_timer_once(set_time_1, set_time_2)
