...
class LaunchAppiumServicesAndroid(object):
    ...
    def pst_pid(self, pid):
        ...
        [tmp(int(i[1])) or self.appium_pid.append(psutil.Process(int(i[1]))) for i in bp_port]
        """
        try:
    ...
    def launch_appium(self):
        ...
        [self.pst_pid(i[1]) or self.appium_pid.append(i[1]) for i in bp_port if psutil.pid_exists(i[1])]
