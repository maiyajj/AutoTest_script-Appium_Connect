...
class GNF1331NormalTimer10(WidgetOperation):
    ...
    def case(self):
        ...
        self.debug.info(u"[APP_INFO]device state: \n"
                        u"btn_state_list: %s;\n"
                        u"set_delay_timer_list: %s;\n"
                        u"set_cycle_timer_list: %s;\n"
                        u"set_normal_timer_list: %s;\n"
                        u"launch_delay_timer_list: %s;\n"
                        u"launch_cycle_timer_on_list: %s;\n"
                        u"launch_cycle_timer_off_list: %s;\n"
                        u"launch_normal_timer_once_list: %s;\n"
                        u"timer_list: %s;\n"
                        u"result: %s;"
                        % (btn_state_list, set_delay_timer_list, set_cycle_timer_list, set_normal_timer_list,
                           launch_delay_timer_list, launch_cycle_timer_on_list, launch_cycle_timer_off_list,
                           launch_normal_timer_once_list, timer_list, result))
        ...
        self.debug.info(u"[APP_INFO]timer_list: %s;\n"
                        u"up_launch_delay_timer_list: %s;\n"
                        u"mid_launch_cycle_timer_on_list: %s;\n"
                        u"mid_launch_cycle_timer_off_list: %s;\n"
                        u"down_launch_normal_timer_4_list: %s;\n"
                        u"down_launch_normal_timer_5_list: %s;"
                        % (timer_list, up_launch_delay_timer_list, mid_launch_cycle_timer_on_list,
                           mid_launch_cycle_timer_off_list, down_launch_normal_timer_4_list,
                           down_launch_normal_timer_5_list))
        # 上层
        # 设置
