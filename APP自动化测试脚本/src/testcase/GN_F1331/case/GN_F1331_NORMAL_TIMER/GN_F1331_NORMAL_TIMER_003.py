...
class GNF1331NormalTimer3(WidgetOperation):
    ...
    def case(self):
        ...
        self.debug.info(u"[APP_INFO]timer_list: %s;\n"
                        ...
                        u"down_launch_cycle_timer_on_list: %s;\n"
                        u"up_launch_cycle_timer_off_list: %s;\n"
                        u"mid_launch_cycle_timer_off_list: %s;\n"
                        u"down_launch_cycle_timer_off_list: %s;\n"
                        % (timer_list, up_launch_cycle_timer_on_list, mid_launch_cycle_timer_on_list,
                           down_launch_cycle_timer_on_list, up_launch_cycle_timer_off_list,
                           mid_launch_cycle_timer_off_list, down_launch_cycle_timer_off_list))
        # 上层
        # 设置
