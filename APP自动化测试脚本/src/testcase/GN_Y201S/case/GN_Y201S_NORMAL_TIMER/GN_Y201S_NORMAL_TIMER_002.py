...
class GNY201SNormalTimer2(WidgetOperation):
    @case_run(False)
    def run(self):
    ...
    def case(self):
        ...
        delay_time_1 = 2
        start_time_1, set_time_1, cycle1 = self.create_normal_timer(now, delay_time_1, "power_off", u"永不")
        ...
        self.check_timer(device, start_time_1, set_time_1, u"关", cycle1)
