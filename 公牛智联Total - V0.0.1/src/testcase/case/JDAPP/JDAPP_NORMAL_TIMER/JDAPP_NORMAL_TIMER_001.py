...
class JDAppNormalTimer1(LaunchAppJD):
    ...
    def case(self):
        ...
        self.check_timer(delay_time_1, u"设备已开启", True, True, set_time_1)
        self.check_timer(delay_time_2 - delay_time_1, u"设备已开启", True, True, set_time_2)
        self.check_timer(delay_time_3 - delay_time_2, u"设备已关闭", True, True, set_time_3)
        self.check_timer(delay_time_4 - delay_time_3, u"设备已关闭", True, True, set_time_4)
