...
class ALAppTimerTime5(WidgetOperationAL):
    @case_run(False)
    def run(self):
        self.case_module = u"FUT_MTIMER_TIME热水器模式_小夜灯_取暖器模式(#58)"  # 用例所属模块
        self.case_title = u'FUT_MTIMER_TIME_模式定时状态下手动改变设备状态'  # 用例名称
        self.zentao_id = 443  # 禅道ID
    ...
    def case(self):
        ...
        for elem, page, mode_info in timer_list:
            ...
            self.check_timer(device, start_time_1, set_time_1, u"设备已关闭", True)
