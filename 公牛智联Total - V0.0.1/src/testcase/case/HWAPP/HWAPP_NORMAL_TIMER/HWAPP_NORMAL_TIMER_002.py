...
class HWAppNormalTimer2(WidgetOperationHW):
    ...
    def case(self):
        ...
        start_time_1, set_time_1 = self.create_normal_timer(now, time_on=delay_time_1, loop=[u"周一", u"周三", u"周五"])

        delay_time_2 = ["point", "10:00"]
        start_time_2, set_time_2 = self.create_normal_timer(now, time_off=delay_time_2, loop=[u"周一", u"周三", u"周五"])

        delay_time_3 = ["point", "11:00"]
        start_time_3, set_time_3 = self.create_normal_timer(now, time_on=delay_time_3, loop=[u"周一", u"周三", u"周五"])

        delay_time_4 = ["point", "12:00"]
        start_time_4, set_time_4 = self.create_normal_timer(now, time_off=delay_time_4, loop=[u"周一", u"周三", u"周五"])

        delay_time_5 = ["point", "13:00"]
        start_time_5, set_time_5 = self.create_normal_timer(now, time_on=delay_time_5, loop=[u"周一", u"周三", u"周五"])

        delay_time_6 = ["point", "14:00"]
        start_time_6, set_time_6 = self.create_normal_timer(now, time_off=delay_time_6, loop=[u"周一", u"周三", u"周五"])

        delay_time_7 = ["point", "15:00"]
        start_time_7, set_time_7 = self.create_normal_timer(now, time_on=delay_time_7, loop=[u"周一", u"周三", u"周五"])

        delay_time_8 = ["point", "16:00"]
        start_time_8, set_time_8 = self.create_normal_timer(now, time_off=delay_time_8, loop=[u"周一", u"周三", u"周五"])
