...
class HWAppNormalTimer5(WidgetOperationHW):
    ...
    def case(self):
        ...
        delay_time_1 = 1
        start_time_1, set_time_1, cycle1 = self.create_normal_timer(now, time_on=delay_time_1, delay_s=delay_s)

        delay_time_2 = 2
        start_time_2, set_time_2, cycle2 = self.create_normal_timer(now, time_off=delay_time_2, delay_s=delay_s)
        ...
        delay_time_3 = 2
        start_time_3, set_time_3, cycle3 = self.create_normal_timer(now, time_on=delay_time_3, delay_s=delay_s)

        delay_time_4 = 4
        start_time_4, set_time_4, cycle4 = self.create_normal_timer(now, time_off=delay_time_4, delay_s=delay_s)

        delay_time_5 = 6
        start_time_5, set_time_5, cycle5 = self.create_normal_timer(now, time_on=delay_time_5, delay_s=delay_s)

        delay_time_6 = 8
        start_time_6, set_time_6, cycle6 = self.create_normal_timer(now, time_off=delay_time_6, delay_s=delay_s)

        delay_time_7 = 10
        start_time_7, set_time_7, cycle7 = self.create_normal_timer(now, time_on=delay_time_7, delay_s=delay_s)

        delay_time_8 = 12
        start_time_8, set_time_8, cycle8 = self.create_normal_timer(now, time_off=delay_time_8, delay_s=delay_s)
