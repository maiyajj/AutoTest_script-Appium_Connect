...
class GNAppAccountSettings12(LaunchApp):
    def run(self):
        self.case_module = u"账户设置"  # 用例所属模块
        self.case_title = u'密码修改页面，旧密码为空，提示信息检查'  # 用例名称
        self.zentao_id = 1966  # 禅道ID
    ...
    def case(self):
        try:
            ...
            widget_px = self.page["change_pwd_page"]["commit"][3]["px"]
